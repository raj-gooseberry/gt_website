...
const FAQs2 = ({ header, items, id, hasBackground = false }: FAQsProps) => (
  <WidgetWrapper id={id ? id : ''} hasBackground={hasBackground} containerClass="max-w-6xl">
    ...
    <Collapse
      ...
      iconUp={<IconChevronUp className="h-6 w-6 text-primary-600 dark:text-dark-200" />}
      iconDown={<IconChevronDown className="h-6 w-6 text-primary-600 dark:text-dark-200" />}
    />
  </WidgetWrapper>
);
