      ...
      <article>
        <header className={post.image ? 'text-center' : ''}>
          ...
          {post.image ? (
            <Image
              src={post.image}
              className="mx-auto mt-4 mb-6 max-w-full bg-dark-400 dark:bg-dark-700 sm:rounded-md lg:max-w-6xl"
